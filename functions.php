<?php
/*--------------------------------------------------------------------*/
/*	THIS FILE IS A PART OF THE THEME FRAMEWORK - YOU'VE BEEN WARNED ;)
/*--------------------------------------------------------------------*/
...
function bean_constants() {
	...
	define( 'BEAN_DOCUMENTATION_URL', 'http://www.support.themebeans.com' );
	define( 'BEAN_SUPPORT_URL', 'http://www.support.themebeans.com' );
...
function bean_load_framework() {
	...
	require( BEAN_LIB_DIR . '/plugins/class-tgm-plugin-activation.php' ); //PLUGIN ACTIVATOR
	...
	if( bean_theme_supports( 'primary', 'widgets' ) ){
		...
		include( BEAN_WIDGETS_DIR . '/widget-recent-posts.php' );
		include( BEAN_WIDGETS_DIR . '/widget-recent-portfolio.php' );
		include( BEAN_WIDGETS_DIR . '/widget-testimonials.php' );
		include( BEAN_WIDGETS_DIR . '/widget-intro.php' );
		include( BEAN_WIDGETS_DIR . '/widget-call-to-action.php' );
		include( BEAN_WIDGETS_DIR . '/widget-skills.php' );
		include( BEAN_WIDGETS_DIR . '/widget-clients.php' );
		include( BEAN_WIDGETS_DIR . '/widget-stats.php' );
	}
	...
	if( is_admin() ) { 
		...
		if( bean_theme_supports( 'primary', 'meta' ) ) {
			...
			include( BEAN_LIB_DIR . '/metaboxes/meta-page.php');
			include( BEAN_LIB_DIR . '/metaboxes/meta-post.php');
			include( BEAN_LIB_DIR . '/metaboxes/meta-portfolio.php');
			include( BEAN_LIB_DIR . '/metaboxes/meta-slider.php');
			include( BEAN_LIB_DIR . '/metaboxes/meta-team.php');
		}
		...
		if( bean_theme_supports( 'primary', 'responsive' ) )
